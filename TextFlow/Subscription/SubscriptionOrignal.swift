...
import SwiftUI
import DocumentKit
struct SubscriptionOrignal: View, DocumentGroupModal {
                ...
                ZStack {
                    ...
                    VStack(spacing: 0){
                        ...
                        Button{
                            ...
                            Image(systemName: "xmark.circle.fill").foregroundStyle(forcedColor == .dark ? .black : .white ,forcedColor == .dark ? Color(hex: "272727") : Color(hex:"CECECE")).font(.system(size: 22)).padding(.leading, 21)
                        }
                    ...
                    VStack{
                                ...
                                .padding(.top, 6)
                                    VStack(spacing: 0){
                                        ...
                                        VStack(spacing: 0){
                                            ...
                                            .background(forcedColor == .dark ? Color(hex:"#1C1C1E") : Color(hex: "FFFFFF"))
                        ...
                        .frame(alignment: .bottom)
                            .padding(.top, 10)
                            .background(forcedColor == .dark ? Color(hex:"#1C1C1E") :  .white)
                     }
                    .padding(.top, 0)
                        
                }
            }.navigationBarBackButtonHidden().preferredColorScheme(.light)
        }else{
            SubscribedScreen()
        }
    }
